...
import 'package:stuwrite_user/data/reposotories/data_sync_repo.dart';
...
import 'package:stuwrite_user/features/address/domain/repositories/address_repository_interface.dart';
import 'package:stuwrite_user/features/address/domain/services/address_service.dart';
import 'package:stuwrite_user/features/address/domain/services/address_service_interface.dart';
import 'package:stuwrite_user/features/auth/controllers/facebook_login_controller.dart';
import 'package:stuwrite_user/features/auth/controllers/google_login_controller.dart';
import 'package:stuwrite_user/features/auth/domain/repositories/auth_repository.dart';
import 'package:stuwrite_user/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:stuwrite_user/features/auth/domain/services/auth_service.dart';
import 'package:stuwrite_user/features/auth/domain/services/auth_service_interface.dart';
import 'package:stuwrite_user/features/banner/controllers/banner_controller.dart';
import 'package:stuwrite_user/features/banner/domain/repositories/banner_repository.dart';
import 'package:stuwrite_user/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:stuwrite_user/features/banner/domain/services/banner_service.dart';
...
import 'package:stuwrite_user/features/brand/domain/repositories/brand_repository.dart';
import 'package:stuwrite_user/features/brand/domain/services/brand_service.dart';
import 'package:stuwrite_user/features/brand/domain/services/brand_service_interface.dart';
import 'package:stuwrite_user/features/cart/domain/repositories/cart_repository.dart';
import 'package:stuwrite_user/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:stuwrite_user/features/cart/domain/services/cart_service.dart';
import 'package:stuwrite_user/features/cart/domain/services/cart_service_interface.dart';
import 'package:stuwrite_user/features/category/domain/repositories/category_repo.dart';
import 'package:stuwrite_user/features/category/domain/repositories/category_repo_interface.dart';
import 'package:stuwrite_user/features/category/domain/services/category_service.dart';
import 'package:stuwrite_user/features/category/domain/services/category_service_interface.dart';
import 'package:stuwrite_user/features/chat/domain/repositories/chat_repository.dart';
import 'package:stuwrite_user/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:stuwrite_user/features/chat/domain/services/chat_service.dart';
import 'package:stuwrite_user/features/chat/domain/services/chat_service_interface.dart';
import 'package:stuwrite_user/features/checkout/controllers/checkout_controller.dart';
import 'package:stuwrite_user/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:stuwrite_user/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:stuwrite_user/features/checkout/domain/services/checkout_service.dart';
import 'package:stuwrite_user/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:stuwrite_user/features/compare/controllers/compare_controller.dart';
import 'package:stuwrite_user/features/compare/domain/repositories/compare_repository.dart';
import 'package:stuwrite_user/features/compare/domain/repositories/compare_repository_interface.dart';
import 'package:stuwrite_user/features/compare/domain/services/compare_service.dart';
import 'package:stuwrite_user/features/compare/domain/services/compare_service_interface.dart';
import 'package:stuwrite_user/features/contact_us/controllers/contact_us_controller.dart';
import 'package:stuwrite_user/features/contact_us/domain/repository/contact_us_repository.dart';
import 'package:stuwrite_user/features/contact_us/domain/repository/contact_us_repository_interface.dart';
import 'package:stuwrite_user/features/contact_us/domain/services/contact_us_service.dart';
import 'package:stuwrite_user/features/contact_us/domain/services/contact_us_service_interface.dart';
import 'package:stuwrite_user/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:stuwrite_user/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:stuwrite_user/features/coupon/domain/services/coupon_service.dart';
import 'package:stuwrite_user/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:stuwrite_user/features/address/domain/repositories/address_repository.dart';
...
import 'package:stuwrite_user/features/deal/domain/repositories/featured_deal_repository.dart';
import 'package:stuwrite_user/features/deal/domain/repositories/featured_deal_repository_interface.dart';
import 'package:stuwrite_user/features/deal/domain/repositories/flash_deal_repository.dart';
import 'package:stuwrite_user/features/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:stuwrite_user/features/deal/domain/services/featured_deal_service.dart';
import 'package:stuwrite_user/features/deal/domain/services/featured_deal_service_interface.dart';
import 'package:stuwrite_user/features/deal/domain/services/flash_deal_service.dart';
import 'package:stuwrite_user/features/deal/domain/services/flash_deal_service_interface.dart';
import 'package:stuwrite_user/features/location/controllers/location_controller.dart';
import 'package:stuwrite_user/features/location/domain/repositories/location_repository.dart';
import 'package:stuwrite_user/features/location/domain/repositories/location_repository_interface.dart';
import 'package:stuwrite_user/features/location/domain/services/location_service.dart';
import 'package:stuwrite_user/features/location/domain/services/location_service_interface.dart';
import 'package:stuwrite_user/features/loyaltyPoint/controllers/loyalty_point_controller.dart';
import 'package:stuwrite_user/features/loyaltyPoint/domain/repositories/loyalty_point_repository_interface.dart';
import 'package:stuwrite_user/features/loyaltyPoint/domain/services/loyalty_poin_service.dart';
import 'package:stuwrite_user/features/loyaltyPoint/domain/services/loyalty_point_service_interface.dart';
import 'package:stuwrite_user/features/notification/controllers/notification_controller.dart';
import 'package:stuwrite_user/features/notification/domain/repositories/notification_repository.dart';
import 'package:stuwrite_user/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:stuwrite_user/features/notification/domain/services/notification_service.dart';
import 'package:stuwrite_user/features/notification/domain/services/notification_service_interface.dart';
import 'package:stuwrite_user/features/onboarding/controllers/onboarding_controller.dart';
import 'package:stuwrite_user/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:stuwrite_user/features/onboarding/domain/repositories/onboarding_repository_interface.dart';
import 'package:stuwrite_user/features/onboarding/domain/services/onboarding_service.dart';
...
import 'package:stuwrite_user/features/order/domain/repositories/order_repository.dart';
import 'package:stuwrite_user/features/order/domain/repositories/order_repository_interface.dart';
import 'package:stuwrite_user/features/order/domain/services/order_service.dart';
import 'package:stuwrite_user/features/order/domain/services/order_service_interface.dart';
...
import 'package:stuwrite_user/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:stuwrite_user/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:stuwrite_user/features/order_details/domain/services/order_details_service.dart';
import 'package:stuwrite_user/features/order_details/domain/services/order_details_service_interface.dart';
...
import 'package:stuwrite_user/features/product/domain/repositories/product_repository.dart';
import 'package:stuwrite_user/features/product/domain/repositories/product_repository_interface.dart';
import 'package:stuwrite_user/features/product/domain/repositories/seller_product_repository.dart';
import 'package:stuwrite_user/features/product/domain/repositories/seller_product_repository_interface.dart';
import 'package:stuwrite_user/features/product/domain/services/product_service.dart';
import 'package:stuwrite_user/features/product/domain/services/product_service_interface.dart';
import 'package:stuwrite_user/features/product/domain/services/seller_product_service.dart';
import 'package:stuwrite_user/features/product/domain/services/seller_product_service_interface.dart';
import 'package:stuwrite_user/features/product_details/controllers/product_details_controller.dart';
import 'package:stuwrite_user/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:stuwrite_user/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:stuwrite_user/features/product_details/domain/services/product_details_service.dart';
import 'package:stuwrite_user/features/product_details/domain/services/product_details_service_interface.dart';
import 'package:stuwrite_user/features/profile/controllers/profile_contrroller.dart';
import 'package:stuwrite_user/features/profile/domain/repositories/profile_repository.dart';
import 'package:stuwrite_user/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:stuwrite_user/features/profile/domain/services/profile_service.dart';
import 'package:stuwrite_user/features/profile/domain/services/profile_service_interface.dart';
import 'package:stuwrite_user/features/refund/controllers/refund_controller.dart';
import 'package:stuwrite_user/features/refund/domain/repositories/refund_repository.dart';
import 'package:stuwrite_user/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:stuwrite_user/features/refund/domain/services/refund_service.dart';
import 'package:stuwrite_user/features/refund/domain/services/refund_service_interface.dart';
import 'package:stuwrite_user/features/reorder/controllers/re_order_controller.dart';
import 'package:stuwrite_user/features/reorder/domain/repositories/re_order_repository.dart';
import 'package:stuwrite_user/features/reorder/domain/repositories/re_order_repository_interface.dart';
import 'package:stuwrite_user/features/reorder/domain/services/re_order_service.dart';
import 'package:stuwrite_user/features/reorder/domain/services/re_order_service_interface.dart';
import 'package:stuwrite_user/features/restock/controllers/restock_controller.dart';
import 'package:stuwrite_user/features/restock/domain/repositories/restock_repository.dart';
import 'package:stuwrite_user/features/restock/domain/repositories/restock_repository_interface.dart';
import 'package:stuwrite_user/features/restock/domain/services/restock_service.dart';
import 'package:stuwrite_user/features/restock/domain/services/restock_service_interface.dart';
import 'package:stuwrite_user/features/review/controllers/review_controller.dart';
import 'package:stuwrite_user/features/review/domain/repositories/review_repository.dart';
import 'package:stuwrite_user/features/review/domain/repositories/review_repository_interface.dart';
import 'package:stuwrite_user/features/review/domain/services/review_service.dart';
import 'package:stuwrite_user/features/review/domain/services/review_service_interface.dart';
import 'package:stuwrite_user/features/search_product/domain/repositories/search_product_repository_interface.dart';
import 'package:stuwrite_user/features/search_product/domain/services/search_product_service.dart';
import 'package:stuwrite_user/features/search_product/domain/services/search_product_service_interface.dart';
import 'package:stuwrite_user/features/shipping/controllers/shipping_controller.dart';
import 'package:stuwrite_user/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:stuwrite_user/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:stuwrite_user/features/shipping/domain/services/shipping_service.dart';
import 'package:stuwrite_user/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:stuwrite_user/features/shop/domain/repositories/shop_repository.dart';
import 'package:stuwrite_user/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:stuwrite_user/features/shop/domain/services/shop_service.dart';
import 'package:stuwrite_user/features/shop/domain/services/shop_service_interface.dart';
import 'package:stuwrite_user/features/splash/controllers/splash_controller.dart';
import 'package:stuwrite_user/features/splash/domain/repositories/splash_repository.dart';
import 'package:stuwrite_user/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:stuwrite_user/features/splash/domain/services/splash_service.dart';
import 'package:stuwrite_user/features/splash/domain/services/splash_service_interface.dart';
import 'package:stuwrite_user/features/support/controllers/support_ticket_controller.dart';
import 'package:stuwrite_user/features/support/domain/repositories/support_ticket_repository.dart';
import 'package:stuwrite_user/features/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:stuwrite_user/features/support/domain/services/support_ticket_service.dart';
import 'package:stuwrite_user/features/support/domain/services/support_ticket_service_interface.dart';
import 'package:stuwrite_user/features/wallet/controllers/wallet_controller.dart';
import 'package:stuwrite_user/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:stuwrite_user/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:stuwrite_user/features/wallet/domain/services/wallet_service.dart';
...
import 'package:stuwrite_user/features/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:stuwrite_user/features/wishlist/domain/repositories/wishlist_repository_interface.dart';
import 'package:stuwrite_user/features/wishlist/domain/services/wishlist_service.dart';
import 'package:stuwrite_user/features/wishlist/domain/services/wishlist_service_interface.dart';
import 'package:stuwrite_user/helper/network_info.dart';
